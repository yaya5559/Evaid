        ...
        <main className="scroll-snap-container" id="main">
          ...
          <section id="section4" className="snap-section section4" aria-label="Contact">
            <div className="contact-container">
              ...
              {/* Left Column: Existing Contact Details */}
              ...
              {/* Right Column: New Interactive Contact Form */}
              <div className="contact-form-wrapper">
                <form className="contact-form" onSubmit={(e) => { e.preventDefault(); alert('Message dispatched successfully.'); }}>
                  ...
                  <div className="form-field">
                    <label>Message</label>
                    <textarea placeholder="Provide detailed operational request notes..." required></textarea>
                  </div>

                  <button type="submit" className="welcome-btn welcome-btn-primary">
                    Send Message
                  </button>
                </form>
              </div>
